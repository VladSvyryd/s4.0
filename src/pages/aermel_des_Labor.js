...
function Aermel_des_Labors(props) {
    ...
    const aufgabe = {
        labels: [
            "weil Sie sonst an einer Apparatur hängen bleiben könnten.",
            "weil Ihre Haut sonst ohne jeglichen Schutz ist.",
            "weil das nicht so gut aussieht."
        ],
                ...
                <Grid style={{ width: "100%" }} padded="horizontally">
                    <Grid.Row columns="2">
                        <Grid.Column width="11" className="relative">
                            ...
                            >
                                {exercise.pages[5].done ? <Image src={i7} /> : <Image src={i3} />}
                            </div>
                            <div
                                className="absolute  "
                                        ...
                                        <div className=" gridList " style={{ columnGap: "30px" }}>
                                            ...
                                            <div>
                                                ...
                                                <p style={{ marginTop: "5px" }}>
                                                    Die Ärmel am Laborkittel dürfen niemals hochgekrempelt werden.


                        </p>
                                                <Image src={i8} style={{ marginTop: "40px", border: " 1px solid grey" }} />
                                            </div>
                                        </div>
...
export default withRouter(Aermel_des_Labors);
