...
import i8 from "../assets/pics/7-mitarbeiter/sidebar_schuhe.jpg";
...
function Schuhe(props) {
    ...
    const aufgabe = {
        labels: [
            "Es werden keine besonderen Anforderungen an die Schuhe gestellt.",
                                        ...
                                        <div className="gridList">
                                            <div>
                                                <h1 className="my_title small">
                                                    Welche Art von Schuhen sind für die Arbeit im Labor vorgeschrieben?
                                                </h1>
                                            </div>
                                            <Image src={i4} />
                                        </div>
...
export default withRouter(Schuhe);
